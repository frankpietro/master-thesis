...
subject to {
	...
	*/
	...
	forall (o in Operators, d in Days, p in Patients : feasiblePatients[o][p] == 1) {
		...
		movement[numPatients + o][p][o][d] + sum(i in Patients : feasiblePatients[o][i] == 1 && visitRequest[i][d] == 1) movement[i][p][o][d] == assignment[p][o] * visitRequest[p][d];
		movement[p][numPatients + o][o][d] + sum(j in Patients : feasiblePatients[o][j] == 1 && visitRequest[j][d] == 1) movement[p][j][o][d] == assignment[p][o] * visitRequest[p][d];
